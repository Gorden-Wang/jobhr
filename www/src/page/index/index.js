    ...
    index.prototype = {
        ...
        fetchData: function () {
            ...
            $.ajax({
                type: "POST",
                data: "data={'type':'bd'}",
                url: "http://localhost:3000/search?callback=?&data=" + that.makePost("bd", "java", "beijing", "1"),
                dataType: "jsonp",
                jsonp: "callback",
        ...
        fetchAliData: function () {
            ...
            $.ajax({
                type: "POST",
                data: "data={'type':'bd'}",
                url: "http://localhost:3000/search?callback=?&data=" + that.makePost("al", "java", "beijing", "1"),
                dataType: "jsonp",
                jsonp: "callback",
                success: function (data) {
                    console.log(data);
